...
const endpoints = require("../endpoints/epProspect.js");
const tests = require("../commonsTestsAPI");
const commons = require("../commons");
const url = commons.baseAPI.urlAutentication;
const options = commons.options;
const HTTPStatusCodes = require("../httpStatusCodes");
const getEndpoints = endpoints.endpointsProspect.filter(
    (e) => e.method === "get"
);
const putEndpoints = endpoints.endpointsProspect.filter(
    (e) => e.method === "put"
);
let tok = "";

describe("Testando APIs de Prospect", () => {
    before((done) => {
