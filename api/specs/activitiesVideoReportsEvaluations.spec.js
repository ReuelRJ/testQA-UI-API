...
const endpoints = require("../endpoints/epActivitiesVideoReportsEvaluations");
...
const getEndpoints = endpoints.endPointVideoReportsEvaluations.filter(
    (e) => e.method === "get"
);
const putEndpoints = endpoints.endPointVideoReportsEvaluations.filter(
    (e) => e.method === "put"
);
let tok = "";

describe("Testando APIs de Activities Video Reports Evaluations", () => {
    before((done) => {
