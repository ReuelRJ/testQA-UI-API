...
const endpoints = require("../endpoints/epResearch.js");
const tests = require("../commonsTestsAPI");
const commons = require("../commons");
const url = commons.baseAPI.urlAutentication;
const options = commons.options;
const HTTPStatusCodes = require("../httpStatusCodes");
const getEndpoints = endpoints.endpointsResearch.filter(
    (e) => e.method === "get"
);
const putEndpoints = endpoints.endpointsResearch.filter(
    (e) => e.method === "put"
);
let tok = "";

describe("Testando APIs de Research", () => {
    before((done) => {
