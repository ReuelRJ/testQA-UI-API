...
const endpoints = require("../endpoints/epVariety.js");
const tests = require("../commonsTestsAPI");
const commons = require("../commons");
const url = commons.baseAPI.urlAutentication;
const options = commons.options;
const HTTPStatusCodes = require("../httpStatusCodes");
const getEndpoints = endpoints.endpointsVariety.filter((e) => e.method === "get");
const putEndpoints = endpoints.endpointsVariety.filter((e) => e.method === "put");
let tok = "";


describe("Testando APIs de Variety", () => {
    before((done) => {
