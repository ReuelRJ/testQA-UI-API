...
const endpoints = require("../endpoints/epActivitiesOpnionEvaluations");
...
const getEndpoints = endpoints.endPointActivitiesOpnionEvaluations.filter(
  (e) => e.method === "get"
);
const putEndpoints = endpoints.endPointActivitiesOpnionEvaluations.filter(
  (e) => e.method === "put"
);
let tok = "";

describe("Testando APIs de Activities Opnion Evaluations", () => {
  before((done) => {
    ...
    describe("Realizando Tests Unauthorized - 401", () => {
      for(let val of getEndpoints){
